...
import '../CSS/DriverVehicleRequest.css';

const DriverVehicleRequest = () => {
    ...
    const getStatusClass = (status) => {
        switch (status) {
            ...
            case 'TRIP_PROCESS_CONFIRMED': return 'driver-dashboard-status-confirmed';
    ...
    const translateStatus = (status) => {
        switch (status) {
            ...
            case 'TRIP_STARTED': return 'Running (Ongoing)';
            case 'TRIP_PROCESS_CONFIRMED': return 'TRIP PROCESS CONFIRMED';
    ...
    return (
        <div className="driver-dashboard-container fade-in">
            ...
            <div className="driver-dashboard-control-panel">
                ...
                <div className="driver-dashboard-filters">
                    ...
                    >
                        ...
                        <option value="TRIP_PROCESS_CONFIRMED">Confirmed</option>
            ...
            {loading ? (
                ...
                <div className="driver-dashboard-error-alert">{error}</div>
                        ...
                        <tbody className="driver-dashboard-tbody">
                            {filteredTrips.map((trip) => (
                                <tr key={trip.id || trip._id} className="driver-dashboard-tr">
                                    <td data-label="Officer's Name & Division" className="driver-dashboard-td">
                                    ...
                                    <td className="driver-dashboard-td">
                                        {trip.status === 'TRIP_PROCESS_CONFIRMED' ? (
                                            <button
                                                className="driver-dashboard-end-btn"
                                                onClick={() => handleStartTrip(trip.id || trip._id)}
                                                disabled={processingId === (trip.id || trip._id)}
                                                style={{ backgroundColor: '#2a9d8f', }}
                                            >
                                                {processingId === (trip.id || trip._id) ? "Wait..." : "Start Trip"}
                                            </button>
                                            ...
                                            <span className="driver-dashboard-done-text" style={{ color: '#2e7d32', fontWeight: 'bold' }}>✓ Completed</span>
                                        ) : (
                                            <span className="driver-dashboard-waiting-text">Waiting for Admin</span>
                                        )}
                                    </td>
                                </tr>
                            ))}
...
export default DriverVehicleRequest;