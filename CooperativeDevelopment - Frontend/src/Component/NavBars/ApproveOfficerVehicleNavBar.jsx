...
const ApproveOfficerVehicleNavBar = () => {
    ...
    const menuItems = [
        { name: 'Dashboard', path: '/ApprovalVehicleDashboard' },
        { name: 'Vehicle Request', path: '/ApproveOfficerVehicle' },
        { name: 'History', path: '/ApproveOfficerVehicleHistory' },
    ];
...
export default ApproveOfficerVehicleNavBar;